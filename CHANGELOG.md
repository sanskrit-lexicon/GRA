...
- 2026-09-18 docs/KASSA_TOCHKA_VS_PARTNER_TCO_COMPARE_18-09-2026.md — TCO-сравнение
  ...
  партнёрской аренды («Специальный тариф №1»); вердикт (правка MG по фактическому
  счёту): облачная подписка Точки исключена — факт 5 000–15 000 ₽/мес против
  заявленных «от 1 350»; победила партнёрская аренда, 36 мес разовый платёж,
  TCO 2 457 ₽/мес.
